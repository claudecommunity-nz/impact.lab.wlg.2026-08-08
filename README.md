...
- `apps/dashboard` — the core Next.js 16 dashboard (common operating picture,
  full-screen regional evidence map with PostGIS report concentrations, personal
  drag/resize widget workspace, module pages, health strip, and the read-only Lab
  activity view of commits, PRs, modules, signals, tables, and media)
