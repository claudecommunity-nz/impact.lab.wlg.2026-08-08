...
└─ summary/
  ...
  "summary"
              ...
              <p className="rounded-lg border border-border bg-muted/25 p-3 text-xs leading-relaxed text-muted-foreground">
                Functions are discovered from their folders—do not list them in the manifest.
                This example is intentionally public and read-only. A function with private
                data or privileged writes must validate the caller inside its handler.
              </p>
            </CardContent>
          </Card>
        </div>
